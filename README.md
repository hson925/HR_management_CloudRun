...
직원 온보딩, 역할 기반 접근 제어, 다회차·다언어 동료/관리자 평가, PDF 리포트 생성, 사내 공지사항을 통합한 풀스택 웹 애플리케이션. 설계부터 배포·운영까지 1인이 단독 수행했습니다.
...
### 4. 운영 및 관측
- **Cloud Run** 배포 (Tokyo 리전), Gunicorn 1 worker × 8 threads, Docker 단일 단계 빌드
